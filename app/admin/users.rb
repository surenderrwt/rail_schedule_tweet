ActiveAdmin.register User do
  ...
  #
  permit_params do
    permitted = [:email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :role_id, :activate, :remember_created_at, :access_token, :access_token_secret, :full_name]
